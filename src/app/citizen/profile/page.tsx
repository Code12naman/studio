...
import { Edit, Save, KeyRound, User, Mail } from "lucide-react";
...
const mockUser = {
    ...
    createdAt: new Date(2023, 10, 15).toLocaleDateString(), // Example registration date
};
...
export default function CitizenProfilePage() {
    ...
    const [email, setEmail] = useState(mockUser.email); // Email might not be editable
                ...
                <CardHeader className="items-center text-center">
                    <div className="relative group mb-4">
                         <Avatar className="h-24 w-24 border-2 border-primary ring-4 ring-primary/20">
                             <AvatarImage src={mockUser.photoURL || undefined} alt={displayName || "User avatar"} data-ai-hint="person face portrait" />
                    ...
                    <CardDescription>Joined on {mockUser.createdAt}</CardDescription>
                </CardHeader>
